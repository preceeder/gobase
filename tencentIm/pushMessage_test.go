...
func TestSendImMessage(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			res := CommonResponse{}
			if err := SendImMessage(tt.args.ctx, tt.args.serverName, tt.args.fromId, tt.args.toId, tt.args.content, tt.args.cloudCustomData, tt.args.sendMsgControl, tt.args.forbidCallbackControl, tt.args.syncOtherMachine, nil, &res); (err != nil) != tt.wantErr {
